...
namespace AnilTools
{
    public static class Extentions
    {
        ...
        public static Vector3 OnlyYRef(this ref Vector3 pos, float value)
        {
            pos.z = 0;
            pos.x = 0;
            pos.y = value;
        ...
        public static T GetRandom<T>(this List<T> array, out int index)
        {
            System.Random random = new System.Random((int)DateTime.Now.Ticks);
            if (array.Count == 0)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float DifranceRGB(this Color a, Color b)
        {
            return Mathf.Pow(a.r - b.r, 2) + Mathf.Pow(a.g - b.g, 2) + Mathf.Pow(a.b - b.b, 2) * 3;
        }
